...
namespace GostCrypt {
	namespace NewFuseDriver {
		...
		private:
			...
			static QSharedPointer<NewCore::VolumeInformation> volumeInfo; /**< Pointer to the Volume Information object containg all information about the mounted volume stored in the control file */
