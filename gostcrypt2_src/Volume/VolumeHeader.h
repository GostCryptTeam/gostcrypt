...
class VolumeHeader
{
 public:
    ...
    bool Decrypt(const BufferPtr& encryptedData, const VolumePassword& password,
                 const VolumeHashList& keyDerivationFunctions, const EncryptionAlgorithmList& encryptionAlgorithms);
    void EncryptNew(BufferPtr& newHeaderBuffer, const BufferPtr& newSalt, const BufferPtr& newHeaderKey,
