...
namespace GostCrypt {
    namespace Core {
		...
		private:
            ...
            QDataStream processStream; /**< Input/Output QDataStream used to serialize requests to the process standard input and serialize responses from the process standard output */
#ifdef GENERATE_REQUESTS_DUMP
            QDataStream requestsDumpStream; /**< Ouput QDataStream used to serialize the requests to a dump file for debug purposes */
            ...
            QQueue<QVariant> waitingRequests; /**< Queue of QVariants containing the requests waiting tobe sent to the service process */
