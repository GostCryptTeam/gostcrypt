...
namespace GostCrypt {
	...
	public:
        ...
        static const size_t PoolSize = RNG_POOL_SIZE; /**< Size of the data pool used by the random generator */
	...
	protected:
        ...
        static const size_t MaxBytesAddedBeforePoolHashMix = RANDMIX_BYTE_INTERVAL; /**< Number of bytes added to the data in the pool between each hash mix */
        ...
        static SecureBuffer Pool; /**< Pool buffer storing intermediate random data used by the random generator */
        static QSharedPointer <Volume::VolumeHash> PoolHash; /**< Hash algorithm used by the random generator for the HashMix */
