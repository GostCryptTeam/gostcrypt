...
class GostCryptException : public QException {
    public:
        ...
        */
        GostCryptException(QString fonction, QString filename, quint32 line) : fonction(fonction), filename(QFileInfo(filename).fileName()), line(line), requestId(0) {}
        /**
...
class FailedWriteFile : public SystemException {
    public:
        ...
        */
        ...
        DEF_EXCEPTION_WHAT(FailedWriteFile, SystemException, "Unable to write on file \""+file.absoluteFilePath() + "\".\n")
    protected:
        QFileInfo file; /**< Path of the file GostCrypt tried to write on */
...
class FailedFlushFile : public SystemException {
    public:
        ...
        */
        ...
        DEF_EXCEPTION_WHAT(FailedFlushFile, SystemException, "Unable to flush data on file \""+file.absoluteFilePath() + "\".\n")
    protected:
...
class FailedCreateDirectory : public SystemException {
    public:
        ...
        */
        FailedCreateDirectory(QString fonction, QString filename, quint32 line, QFileInfo dir) : SystemException(fonction, filename, line), dir(dir) {}
