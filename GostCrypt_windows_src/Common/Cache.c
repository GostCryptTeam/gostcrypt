 ...
 *
 *	\file Cache.c
 *	\brief Manage the cached password the decrypt
 *	\version 1.3.1
 *	\date 15/12/2016
 *
 */
...
/**
 *
 *	\fn int ReadVolumeHeaderWCache (BOOL bBoot, BOOL bCache, char *header, Password *password, PCRYPTO_INFO *retInfo)
 *	\brief Attempt to recognize volume using the mount password.
 *	\param[in] PCRYPTO_INFO * retInfo
 *	\param[in] Password * password
 *	\param[in] char * header
 *	\param[in] BOOL bCache
 *	\param[in] BOOL bBoot
 *	\return int nReturnCode ERR_PASSWORD_WRONG if password is wrong
 *			ReadVolumeHeader (bBoot, header, password, retInfo, NULL) if using cached password
 *			ReadVolumeHeader (bBoot, header, &CachedPasswords[i], retInfo, NULL) using password typed.
 *
 */
...
/**
 *
 *	\fn void AddPasswordToCache (Password *password)
 *	\brief Add the password to the cache
 *	\param[in] Password * password
 *	\return void
 *
 */
 ...
 *
 *	\fn void WipeCache ()
 *	\brief destroy the cache (containing passwords)
 *	\return void
 *
 */
void WipeCache ()
