...
#ifndef GST_HEADER_DRIVER_ENCRYPTED_IO_QUEUE
#define GST_HEADER_DRIVER_ENCRYPTED_IO_QUEUE

#include "Gstdefs.h"
#include "Apidrvr.h"

#if 0
#	define GST_TRACE_IO_QUEUE
#endif

#define GST_ENC_IO_QUEUE_MAX_FRAGMENT_SIZE (256 * 1024)

#define GST_ENC_IO_QUEUE_PREALLOCATED_ITEM_COUNT 8
#define GST_ENC_IO_QUEUE_PREALLOCATED_IO_REQUEST_COUNT 16
...
#endif // GST_HEADER_DRIVER_ENCRYPTED_IO_QUEUE
