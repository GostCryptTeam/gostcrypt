...
#ifndef GST_HEADER_DRIVER_DRIVE_FILTER
#define GST_HEADER_DRIVER_DRIVE_FILTER
...
#define GST_BOOT_DRIVE_FILTER_EXTENSION_MAGIC_NUMBER 0x5452554542455854
...
#define GST_ENCRYPTION_SETUP_IO_BLOCK_SIZE (1536 * 1024)
#define GST_ENCRYPTION_SETUP_HEADER_UPDATE_THRESHOLD (64 * 1024 * 1024)
#define GST_HIBERNATION_WRITE_BUFFER_SIZE (128 * 1024)

#endif // GST_HEADER_DRIVER_DRIVE_FILTER
