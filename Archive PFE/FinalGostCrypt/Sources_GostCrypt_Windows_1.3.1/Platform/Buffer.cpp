...
/**
 *
 *	\fn void Buffer::Allocate (size_t size)
 *	\brief
...
/**
 *
 *	\fn void Buffer::CopyFrom (const ConstBufferPtr &bufferPtr)
 *	\brief
...
/**
 *
 *	\fn void SecureBuffer::Allocate (size_t size)
 *	\brief
 *	\param[in] size_t size)
 *	\return
 *
