...
/**
 *
 *	\fn BOOL AddMountedVolumeToFavorites (HWND hwndDlg, int driveNo, bool systemFavorites)
 *	\brief Add the selected mounted volume to favorites.
 *	\param[in] bool systemFavorites
 *	\param[in] int driveNo
 *	\param[in] HWND hwndDlg
 *	\return BOOL OrganizeFavoriteVolumes (hwndDlg, systemFavorites, favorite)
 *			FALSE if error
 *
 */
...
/**
 *
 *	\fn static BOOL CALLBACK FavoriteVolumesDlgProc (HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam)
 *	\brief Manage the GUI for system and non-system favorites
 *	\param[in] LPARAM lParam
 *	\param[in] WPARAM wParam
 *	\param[in] UINT msg
 *	\param[in] HWND hwndDlg
 *	\return static BOOL 0 if error
 *			1 otherwise
 *
 */
...
/**
 *
 *	\fn static void FillFavoriteVolumesMenu ()
 *	\brief For the GUI fill the menu with options and text.
 *	\return static void
 *
 */
...
/**
 *
 *	\fn static void FillListControl (HWND favoriteListControl, vector <FavoriteVolume> &favorites)
 *	\brief Add the items to the control GUI
 *	\param[in] vector <FavoriteVolume> &favorites
 *	\param[in] HWND favoriteListControl
 *	\return static void
 *
 */
...
/**
 *
 *	\fn static void FillListControlSubItems (HWND FavoriteListControl, int line, const FavoriteVolume &favorite)
 *	\brief Add to the control GUI sub items
 *	\param[in] const FavoriteVolume &favorite
 *	\param[in] int line
 *	\param[in] HWND FavoriteListControl
 *	\return static void
 *
...
/**
 *
 *	\fn wstring GetFavoriteVolumeLabel (const string &volumePath)
 *	\brief Return label for each volume that are favorites.
 *	\param[in] const string &volumePath
...
/**
 *
 *	\fn void LoadFavoriteVolumes ()
 *	\brief Load the favorites volumes
 *	\return void
 *
 */
...
/**
 *
 *	\fn void LoadFavoriteVolumes (vector <FavoriteVolume> &favorites, bool systemFavorites, bool noUacElevation)
 *	\brief Polymorphe of loadgin favorites volumes sending a special vector of favorties.
 *	\param[in] bool noUacElevation
 *	\param[in] bool systemFavorites
 *	\param[in] vector <FavoriteVolume> &favorites
 *	\return void
 *
...
/**
 *
 *	\fn static void OnFavoriteVolumesUpdated ()
 *	\brief When a new favorites volume is set check his status and update.
 *	\return static void
 *
 */
...
/**
 *
 *	\fn BOOL OrganizeFavoriteVolumes (HWND hwndDlg, bool systemFavorites, const FavoriteVolume &newFavorite)
 *	\brief Organise favortie voulmes on the window.
 *	\param[in] const FavoriteVolume &newFavorite
 *	\param[in] bool systemFavorites
 *	\param[in] HWND hwndDlg
 *	\return BOOL DialogBoxParamW (hInst, MAKEINTRESOURCEW (IDD_FAVORITE_VOLUMES), hwndDlg, (DLGPROC) FavoriteVolumesDlgProc, (LPARAM) &args) == IDOK
 *
 */
...
/**
 *
 *	\fn static bool SaveFavoriteVolumes (const vector <FavoriteVolume> &favorites, bool systemFavorites)
 *	\brief Save in a file favorites volumes options
 *	\param[in] bool systemFavorites
 *	\param[in] const vector <FavoriteVolume> &favorites
 *	\return static bool false if error
 *			true otherwise
 *
 */
...
/**
 *
 *	\fn static void SetControls (HWND hwndDlg, const FavoriteVolume &favorite, bool systemFavoritesMode, bool enable)
 *	\brief Set controls for the favorite volumes and enables options to the user so he can change them
 *	\param[in] bool enable
 *	\param[in] bool systemFavoritesMode
 *	\param[in] const FavoriteVolume &favorite
 *	\param[in] HWND hwndDlg
 *	\return static void
 *
...
/**
 *
 *	\fn static void SetFavoriteVolume (HWND hwndDlg, FavoriteVolume &favorite, bool systemFavoritesMode)
 *	\brief Set the options of a volume to put it as a favorite.
 *	\param[in] bool systemFavoritesMode
 *	\param[in] FavoriteVolume &favorite
 *	\param[in] HWND hwndDlg
 *	\return static void
 *
 */
...
/**
 *
 *	\fn void UpdateDeviceHostedFavoriteVolumes ()
 *	\brief Load the favorite volumes with function LoadFavoriteVolumes() and catch if an error appears.
 *	\return void
 *
 */
