 ...
 *
 *	\file Dictionary.c
 *	\briefManage functions on dictionnary
 *	\version 1.3.1
 *	\date 20/01/2017
 *
 */
...
/**
 *
 *	\fn void AddDictionaryEntry (char *key, int intKey, void *value)
 *	\brief Add a dictionnary entry
 *	\param[in] void * value
 *	\param[in] int intKey
 *	\param[in] char * key
 *	\return void
...
/**
 *
 *	\fn void *GetDictionaryValue (const char *key)
 *	\brief Get the dictionnary value with StringKeyMap
...
/**
 *
 *	\fn void *GetDictionaryValueByInt (int intKey)
 *	\briefGet the dictionnary value with IntKeyMap
 *	\param[in] int intKey
 *	\return void *
 *
 */
...
/**
 *
 *	\fn void *AddPoolData (void *data, size_t dataSize)
 *	\brief Add data to a data pool
...
/**
 *
 *	\fn void ClearDictionaryPool ()
 *	\brief clear a dictionnary pool
 *	\return void
 *
 */
