...
namespace GostCrypt
{
	...
	/**
	 *
	 *	\fn void SecurityToken::CheckLibraryStatus ()
	...
	/**
	 *
	 *	\fn void SecurityToken::CloseLibrary ()
	 *	\brief Close library
	 *	\return void
	 *
	 */
	...
	/**
	 *
	 *	\fn void SecurityToken::CloseAllSessions () throw ()
	...
	/**
	 *
	 *	\fn void SecurityToken::CloseSession (CK_SLOT_ID slotId)
	 *	\brief Close one session
	 *	\param[in] CK_SLOT_ID slotId
	 *	\return void
	 *
	 */
	...
	/**
	 *
	 *	\fn void SecurityToken::CreateKeyfile (CK_SLOT_ID slotId, vector <byte> &keyfileData, const string &name)
	 *	\brief
	 *	\param[in] const string & name
	 *	\param[in] vector <byte> & keyfileData
	 *	\param[in] CK_SLOT_ID slotId
	 *	\return void
	 *
	 */
	...
	/**
	 *
	 *	\fn void SecurityToken::DeleteKeyfile (const SecurityTokenKeyfile &keyfile)
	 *	\brief Delete a key file
	 *	\param[in] const SecurityTokenKeyfile
	 *	\return
	 *
	 */
	...
	/**
	 *
	 *	\fn vector <SecurityTokenKeyfile> SecurityToken::GetAvailableKeyfiles (CK_SLOT_ID *slotIdFilter, const wstring keyfileIdFilter)
	 *	\brief Get the available key files
	 *	\param[in] const wstring keyfileIdFilter
	 *	\param[in] CK_SLOT_ID * slotIdFilter
	 *	\return vector <SecurityTokenKeyfile> keyfiles
	 *
	 */
	...
	/**
	 *
	 *	\fn list <SecurityTokenInfo> SecurityToken::GetAvailableTokens ()
	 *	\brief Get available tokens
	 *	\return list <SecurityTokenInfo> tokens
	 *
	 */
	...
	/**
	 *
	 *	\fn SecurityTokenInfo SecurityToken::GetTokenInfo (CK_SLOT_ID slotId)
	 *	\brief Get info on token
	 *	\param[in] CK_SLOT_ID slotId
	...
	/**
	 *
	 *	\fn void SecurityToken::GetKeyfileData (const SecurityTokenKeyfile &keyfile, vector <byte> &keyfileData)
	 *	\brief
	 *	\param[in] vector <byte> & keyfileData
	 *	\param[in] const SecurityTokenKeyfile & keyfile
	 *	\return void
	 *
	 */
	...
	/**
	 *
	 *	\fn vector <CK_OBJECT_HANDLE> SecurityToken::GetObjects (CK_SLOT_ID slotId, CK_ATTRIBUTE_TYPE objectClass)
	 *	\brief Get Objects
	 *	\param[in] CK_ATTRIBUTE_TYPE objectClass
	 *	\param[in] CK_SLOT_ID slotId
	 *	\return vector <CK_OBJECT_HANDLE> objects
	 *
	 */
	...
	/**
	 *
	 *	\fn void SecurityToken::GetObjectAttribute (CK_SLOT_ID slotId, CK_OBJECT_HANDLE tokenObject, CK_ATTRIBUTE_TYPE attributeType, vector <byte> &attributeValue)
	 *	\brief Get object attribut
	 *	\param[in] vector <byte> & attributeValue
	 *	\param[in] CK_ATTRIBUTE_TYPE attributeType
	 *	\param[in] CK_OBJECT_HANDLE tokenObject
	 *	\param[in] CK_SLOT_ID slotId
	 *	\return void
	 *
	 */
	...
	/**
	 *
	 *	\fn list <CK_SLOT_ID> SecurityToken::GetTokenSlots ()
	 *	\brief Get all token slots
	 *	\return list <CK_SLOT_ID> slots
	 *
	 */
	...
	/**
	 *
	 *	\fn bool SecurityToken::IsKeyfilePathValid (const wstring &securityTokenKeyfilePath)
	 *	\brief Check if the path of key file is valid 
	 *	\param[in] const wstring & securityTokenKeyfilePath
 ...
 */
	...
	/**
	 *
	 *	\fn void SecurityToken::Login (CK_SLOT_ID slotId, const string &pin)
	 *	\brief Manage log in
	 *	\param[in] const string & pin
	 *	\param[in] CK_SLOT_ID slotId
	 *	\return void
	 *
	 */
	...
	/**
	 *
	 *	\fn void SecurityToken::LoginUserIfRequired (CK_SLOT_ID slotId)
	 *	\brief Log the user if it is Required
	 *	\param[in] CK_SLOT_ID slotId
	 *	\return void
	 *
	 */
	...
	/**
	 *
	 *	\fn void SecurityToken::InitLibrary (const string &pkcs11LibraryPath, auto_ptr <GetPinFunctor> pinCallback, auto_ptr <SendExceptionFunctor> warningCallback)
	 *	\brief Initialize the library
	 *	\param[in] auto_ptr <SendExceptionFunctor> warningCallback
	 *	\param[in] auto_ptr <GetPinFunctor> pinCallback
	 *	\param[in] const string & pkcs11LibraryPath
	 *	\return
	 *
	 */
	...
	/**
	 *
	 *	\fn void SecurityToken::OpenSession (CK_SLOT_ID slotId)
...
#undef		GST_TOKEN_ERR
	...
	/**
	 *
	 *  \fn void Pkcs11Exception::Show (HWND parent) const
	 *  \brief Show pkcs exception
	...
	/**
	 *
	 *	\fn void Pkcs11Exception::Deserialize (shared_ptr <Stream> stream)
	 *	\brief Deserialize the stream
	 *	\param[in] shared_ptr <Stream> stream
	 *	\return
	 *
	 */
	...
	/**
	 *
	 *	\fn void Pkcs11Exception::Serialize (shared_ptr <Stream> stream) const
	 *	\brief Serialize the stream
	 *	\param[in] shared_ptr <Stream> stream
	 *	\return
	 *
	 */
