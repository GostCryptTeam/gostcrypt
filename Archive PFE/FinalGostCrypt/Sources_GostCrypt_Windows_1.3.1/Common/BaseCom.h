...
#ifndef GST_HEADER_BASE_COM
#define GST_HEADER_BASE_COM

#include <guiddef.h>

template <class GSTlass>
class GostCryptFactory : public IClassFactory
{

public:
	GostCryptFactory (DWORD messageThreadId) : 
	...
	virtual HRESULT STDMETHODCALLTYPE CreateInstance (IUnknown *pUnkOuter, REFIID riid, void **ppvObject)
	{
		...
		GSTlass *gst = new GSTlass (MessageThreadId);
		if (gst == NULL)
			return E_OUTOFMEMORY;

		HRESULT hr = gst->QueryInterface (riid, ppvObject);
