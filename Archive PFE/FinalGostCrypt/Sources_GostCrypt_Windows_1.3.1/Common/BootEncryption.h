...
#ifndef GST_HEADER_Common_BootEncryption
#define GST_HEADER_Common_BootEncryption
...
#pragma pack (pop)
	...
	protected:
		...
		byte *RescueIsoImage;
		byte RescueVolumeHeader[GST_BOOT_ENCRYPTION_VOLUME_HEADER_SIZE];
		byte VolumeHeader[GST_BOOT_ENCRYPTION_VOLUME_HEADER_SIZE];
...
#define GST_ABORT_TRANSFORM_WAIT_INTERVAL	10

#define MIN_HIDDENOS_DECOY_PARTITION_SIZE_RATIO_NTFS	2.1
#define MIN_HIDDENOS_DECOY_PARTITION_SIZE_RATIO_FAT		1.05

#define GST_SYS_BOOT_LOADER_BACKUP_NAME			"Original System Loader"
#define GST_SYS_BOOT_LOADER_BACKUP_NAME_LEGACY	"Original System Loader.bak"	// Deprecated to prevent removal by some "cleaners"

#define GST_SYSTEM_FAVORITES_SERVICE_NAME				GST_APP_NAME "SystemFavorites"
#define	GST_SYSTEM_FAVORITES_SERVICE_LOAD_ORDER_GROUP	"Event Log"
#define GST_SYSTEM_FAVORITES_SERVICE_CMDLINE_OPTION		"/systemFavoritesService"

#endif // GST_HEADER_Common_BootEncryption
