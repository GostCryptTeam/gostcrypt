...
#ifndef GST_HEADER_DLGCODE
#define GST_HEADER_DLGCODE
...
enum
{
	GST_TBXID_LEGAL_NOTICES,
	GST_TBXID_SYS_ENCRYPTION_PRETEST,
	GST_TBXID_SYS_ENC_RESCUE_DISK,
	GST_TBXID_DECOY_OS_INSTRUCTIONS,
	GST_TBXID_EXTRA_BOOT_PARTITION_REMOVAL_INSTRUCTIONS
};

#define GST_APPLICATION_ID	L"GostCryptFoundation.GostCrypt"

#define GST_MUTEX_NAME_SYSENC				"Global\\GostCrypt System Encryption Wizard"
#define GST_MUTEX_NAME_NONSYS_INPLACE_ENC	"Global\\GostCrypt In-Place Encryption Wizard"
#define GST_MUTEX_NAME_APP_SETUP				"Global\\GostCrypt Setup"
#define GST_MUTEX_NAME_DRIVER_SETUP			"Global\\GostCrypt Driver Setup"
...
#define GST_TRY_HEADER_BAK_AFTER_NBR_WRONG_PWD_TRIES		2

#define MAX_MULTI_CHOICES		10		/* Maximum number of options for mutliple-choice dialog */

#define GST_APPD_FILENAME_CONFIGURATION						"Configuration.xml"
#define GST_APPD_FILENAME_SYSTEM_ENCRYPTION					"System Encryption.xml"
#define GST_APPD_FILENAME_DEFAULT_KEYFILES					"Default Keyfiles.xml"
#define GST_APPD_FILENAME_HISTORY							"History.xml"
#define GST_APPD_FILENAME_FAVORITE_VOLUMES					"Favorite Volumes.xml"
#define GST_APPD_FILENAME_SYSTEM_FAVORITE_VOLUMES			GST_APP_NAME " System Favorite Volumes.xml"
#define GST_APPD_FILENAME_NONSYS_INPLACE_ENC					"In-Place Encryption"
#define GST_APPD_FILENAME_NONSYS_INPLACE_ENC_WIPE			"In-Place Encryption Wipe Algo"
#define GST_APPD_FILENAME_POST_INSTALL_TASK_TUTORIAL			"Post-Install Task - Tutorial"
#define GST_APPD_FILENAME_POST_INSTALL_TASK_RELEASE_NOTES	"Post-Install Task - Release Notes"
...
enum
{
	GST_POST_INSTALL_CFG_REMOVE_ALL = 0,
	GST_POST_INSTALL_CFG_TUTORIAL,
	GST_POST_INSTALL_CFG_RELEASE_NOTES
};

extern char *LastDialogId;
extern char *ConfigBuffer;
extern char szHelpFile[GST_MAX_PATH];
extern char szHelpFile2[GST_MAX_PATH];
extern char SecurityTokenLibraryPath[GST_MAX_PATH];
...
enum gst_app_msg_ids
{
	/* WARNING: Changing these values or their meanings may cause incompatibility with other versions
	(for example, if a new version of the GostCrypt installer needed to shut down this version of
	GostCrypt during upgrade, it could fail or do something unwanted because the signal value would
	...
	// Common (inter-app)
	GST_APPMSG_CLOSE_BKG_TASK =						WM_APP + 4,	// Changing this value will prevent smooth upgrades from pre-5.x versions
	GST_APPMSG_SYSENC_CONFIG_UPDATE =				WM_APP + 101,
	GST_APPMSG_TASKBAR_ICON =						WM_APP + 102,
	GST_APPMSG_LOAD_TEXT_BOX_CONTENT =				WM_APP + 103,
	// Mount									
	GST_APPMSG_MOUNT_ENABLE_DISABLE_CONTROLS =		WM_APP + 201,
	GST_APPMSG_MOUNT_SHOW_WINDOW =					WM_APP + 202,
	GST_APPMSG_PREBOOT_PASSWORD_MODE =				WM_APP + 203,
	// Format									
	GST_APPMSG_VOL_TRANSFORM_THREAD_ENDED =			WM_APP + 301,
	GST_APPMSG_FORMAT_FINISHED =						WM_APP + 302,
	GST_APPMSG_FORMAT_USER_QUIT =					WM_APP + 303,
	GST_APPMSG_PERFORM_POST_WMINIT_TASKS =			WM_APP + 304,
	GST_APPMSG_PERFORM_POST_SYSENC_WMINIT_TASKS =	WM_APP + 305,
	GST_APPMSG_NONSYS_INPLACE_ENC_FINISHED =			WM_APP + 306,
	// Setup
	GST_APPMSG_INSTALL_SUCCESS =						WM_APP + 401,
	GST_APPMSG_UNINSTALL_SUCCESS =					WM_APP + 402,
	GST_APPMSG_EXTRACTION_SUCCESS =					WM_APP + 403,
	GST_APPMSG_INSTALL_FAILURE =						WM_APP + 404,
	GST_APPMSG_UNINSTALL_FAILURE =					WM_APP + 405,
	GST_APPMSG_EXTRACTION_FAILURE =					WM_APP + 406
};
