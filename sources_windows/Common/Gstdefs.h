...
// Release date
#define GST_STR_RELEASE_DATE			"January 2016"
#define GST_RELEASE_DATE_YEAR			2016
#define GST_RELEASE_DATE_MONTH			01
...
#define FAST_ERASE32(mem, size) do { volatile uint32 *burnm = (volatile uint32 *)(mem); int burnc = size >> 3; while (burnc--) *burnm++ = 0; } while (0)
...
#define GST_STR_RELEASED_BY "Released by the GostCrypt developers on " GST_STR_RELEASE_DATE
