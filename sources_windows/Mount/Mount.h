...
{
	GST_MLIST_ITEM_FREE = 0,
	GST_MLIST_ITEM_NONSYS_VOL,
	GST_MLIST_ITEM_SYS_PARTITION,
	GST_MLIST_ITEM_SYS_DRIVE
};

#define GST_MAIN_WINDOW_FLAG_ADMIN_PRIVILEGES	0x1

#define TRAYICON_MENU_DRIVE_OFFSET	9000
#define GST_FAVORITE_MENU_CMD_ID_OFFSET 10000
#define GST_FAVORITE_MENU_CMD_ID_OFFSET_END (GST_FAVORITE_MENU_CMD_ID_OFFSET + 1000)
...
BOOL MountFavoriteVolumes (BOOL systemFavorites = FALSE, BOOL logOnMount = FALSE, BOOL hotKeyMount = FALSE, const GostCrypt::FavoriteVolume &favoriteVolumeToMount = GostCrypt::FavoriteVolume());
