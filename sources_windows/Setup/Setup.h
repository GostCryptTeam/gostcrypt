...
static char *szFiles[]=
{
	"AGostCrypt User Guide.pdf",
	"ALicense.txt",
	"AGostCrypt.exe",
	"AGostCrypt Format.exe",
	"Agostcrypt.sys",
	"Agostcrypt-x64.sys",
	"Dgostcrypt.sys",
	"AGostCrypt Setup.exe"
};
...
{
	"GostCrypt User Guide.pdf",
	"License.txt",
	"GostCrypt.exe",
	"GostCrypt Format.exe",
	"gostcrypt.sys",
	"gostcrypt-x64.sys"
};

#define FILENAME_64BIT_DRIVER	"gostcrypt-x64.sys"
...
extern char InstallationPath[GST_MAX_PATH];
extern char SetupFilesDir[GST_MAX_PATH];
