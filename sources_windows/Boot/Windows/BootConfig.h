...
#ifndef GST_HEADER_Boot_BootConfig
#define GST_HEADER_Boot_BootConfig
...
extern char CustomUserMessage[GST_BOOT_SECTOR_USER_MESSAGE_MAX_LENGTH + 1];
...
#endif // GST_HEADER_Boot_BootConfig
