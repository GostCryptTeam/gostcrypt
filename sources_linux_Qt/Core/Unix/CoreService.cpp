...
namespace GostCrypt
{
	...
	{
		shared_ptr <Pipe> inPipe (new Pipe());
		shared_ptr <Pipe> outPipe (new Pipe());
		Pipe errPipe;
	...
	shared_ptr <Pipe> CoreService::AdminInputPipe;
	shared_ptr <Pipe> CoreService::AdminOutputPipe;

	shared_ptr <Pipe> CoreService::InputPipe;
	shared_ptr <Pipe> CoreService::OutputPipe;
