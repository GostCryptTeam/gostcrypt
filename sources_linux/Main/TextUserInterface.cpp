...
namespace GostCrypt
{
	...
	void TextUserInterface::InitSecurityTokenLibrary () const
	{
		...
		try
		{
			SecurityToken::InitLibrary (Preferences.SecurityTokenModule, shared_ptr <GetPinFunctor> (new PinRequestHandler (this)), shared_ptr <SendExceptionFunctor> (new WarningHandler (this)));
		}
		catch (Exception &e)
		{
			ShowError (e);
