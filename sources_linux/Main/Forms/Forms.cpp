...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	LanguageMenuItem = new wxMenuItem ( SettingsMenu, wxID_ANY, wxString(_("Languages") ), wxEmptyString, wxITEM_NORMAL);
	...
	this->Connect( LanguageMenuItem->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnLanguageMenuItemSelected ) );
...
MainFrameBase::~MainFrameBase()
{
	...
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnLanguageMenuItemSelected ) );
...
PreferencesDialogBase::PreferencesDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	Pkcs11ModulePathTextCtrl = new wxTextCtrl( SecurityTokensPage, wxID_ANY, _("/usr/bin/test"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer128->Add( sbSizer37, 0, wxEXPAND, 5 );
	...
	/* END SECURITY TOKEN OPTIONS */
	/*********************************************************************/

	/*********************************************************************/
	/* LANGUAGES OPTIONS */
	LanguagesPage = new wxPanel (PreferencesNotebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
	wxBoxSizer* bSizerLanguages;
	bSizerLanguages = new wxBoxSizer( wxVERTICAL );

	wxStaticBoxSizer* sbSizerLanguages;
	sbSizerLanguages = new wxStaticBoxSizer( new wxStaticBox( LanguagesPage, wxID_ANY, _("Choose your language") ), wxVERTICAL);

	sbSizerLanguages->Add(bSizerLanguages, 0, wxEXPAND, 5);
	PreferencesNotebook->AddPage( LanguagesPage, _("Languages"), false );

	/* END LANGUAGES OPTTIONS */
	/*********************************************************************/
